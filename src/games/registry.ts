...
export const GAMES: GameMeta[] = [
  ...
  },
  {
    ...
    emoji: '⚫',
    category: '棋类',
    description: '15×15 五子连珠，黑白交替，AI 评分表对弈。',
    howToPlay: '点击棋盘交点落子，黑先白后，在横、竖、斜任意方向连成五子即胜。可选难度与先后手，AI 用连子评分表进行攻防。',
    controls: [
      { keys: '点击', label: '落子' },
    ],
  ...
  },
  {
    ...
    emoji: '帥',
    category: '棋类',
    description: '完整走法，蹩马腿/塞象眼/白脸将，AI 简单搜索。',
  ...
  },
  {
    ...
    emoji: '♔',
    category: '棋类',
    description: '六种棋子完整规则，含王车易位、吃过路兵、兵升变，AI α-β。',
  ...
  },
  {
    ...
    emoji: '⚫',
    category: '棋类',
    description: '19×19 棋盘，提子、打劫、数目，AI 基础策略。',
